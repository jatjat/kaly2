package ca.joelathiessen.kaly2.core.tests.pc.unit.persistence
...
import ca.joelathiessen.kaly2.core.subconscious.SubconsciousActedResults
...
class RobotStorageTest {
    ...
    fun testHeartbeat() {
        ...
        val invalidRobot = persist.getRobotStorage(sid = sessionHistory.id.value)
    ...
    fun testMissedHeartbeat() {
        ...
        val validRobot = persist.getRobotStorage(sid = sessionHistory.id.value)
